...
it.unibo.pps.entity.common.Time

/**
 * The environment represent the container for the properties of the simulation.
 * @param width the width of the environment.
 * @param height the height of the environment.
 * @param simulationDays the number of day of the simulation.
 * @param entities set that contains all the entity of the simulation.
 * @param structure set that contains all the entity of the simulation.
 * @param virus the virus of the simulation.
 */
